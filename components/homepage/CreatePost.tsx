...
const CreateButtons: React.FC<CreateButtonsProps> = ({ text, children }) => {
  return (
    <div className="flex-1 flex items-center justify-center py-3 rounded-lg hover:bg-gray-100 text-center cursor-pointer">
      {children}
  ...
  return (
    <div className="py-2 px-3 rounded-lg shadow-md bg-gray-50">
      ...
      <div className="flex items-center">
        <CreateButtons text="Photo/Video">
          <svg
        ...
        <CreateButtons text="Create an event">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            className="h-7 w-7 text-purple-800"
